...
const contact = () => {
  return (
    <>
      {' '}
      <Head>
        <title>Comments Analyzer | Contact</title>
      </Head>
      <section className='flex-1 mt-24 px-6 sm:px-12 md:px-24 lg:px-48'>
        ...
        <div className='flex flex-row  bg-gray-100 rounded-md p-5 mb-4'>
          <div className='w-1/3 flex flex-col sm:flex-row justify-around items-center'>
            <svg
          ...
          <div className='flex flex-col ml-12   w-2/3'>
            <a
              className='hover:text-blue-700 underline text-blue-500'
            ...
            <p className='text-sm '>for CommentsAnalyzer</p>
          </div>
        </div>
        ...
        <div className='flex flex-row items-center bg-gray-100 rounded-md p-5 mb-4'>
          ...
          <div className='w-2/3 flex flex-col ml-12 pr-4'>
            <a
        ...
        <div className='flex flex-row items-center bg-gray-100 rounded-md p-5 mb-4'>
          ...
          <div className='w-2/3 flex flex-col ml-12 pr-4'>
            ...
            <p>
              ...
              concerns concerning this wee project of mine please do not
