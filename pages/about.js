...
const about = () => {
  return (
    <>
      <Head>
        <title>Comments Analyzer | About</title>
      </Head>
        ...
        <div className='divide-y-2 divide-gray-100 leading-relaxed sh'>
          <div className=' mb-10'>
            ...
            <p className='py-3 text-left'>
              ...
              replies of any <span className='italic font-medium'>tweet</span>{' '}
              you supply and then we do something called{' '}
              <span className='underline italic'>sentiment analysis</span>{' '}
              depending on the context of the text. This sentiment analysis uses
              Natural Language Processing 'NLP', a field of Data Science. You
          ...
          <div className='mb-20'>
            ...
            <p className=' py-3 text-left break-words'>
              ...
              technicality later on. Now how it works generally is rather
              simple, first I retrieve all the top-level comments on the post
              and save them, The reason I don't retrieve all the comments is a
              pure business and logical decision, as a big fan of Reddit myself
              I usually find that some of the comments ({' '}
              ...
              entirely. Thus the reason I only take the{' '}
              <strong>top-level</strong> comments. After that, I then run my
              model on each comment to find its sentiment whether it be:{' '}
            ...
            <p className='py-3 text-left'>
              ...
              to the official documentation of the library. To be frank it is
              one of the nicest documentation I ever came across. But before you
              are able to use this library you need to sign-up for Reddit API
              access. Here is a{' '}
              <a href='#' className='text-blue-600 underline'>
                link
              </a>{' '}
            ...
            <p>
              After that, I use the Natural Language Toolkit ( known more
              commonly as <strong>NLTK</strong> ) to find the FreqDist of the
              comments. Then after l get all these results I save them to a
              Python dict().
            </p>
          </div>
          <div className=' mb-16'>
            <div className='flex flex-row items-center'>
              <h2 className=' font-bold mb-2 mt-4 md:text-xl'>
                How does it work with{' '}
                <strong className='tracking-wide text-[#1da1f2]'>
                  Twitter
                </strong>{' '}
                ?
              </h2>
            ...
            <p>
              ...
              there will be a limit on the number of tweets/replies retrieved.
              In the case this changes in the future ( either I upgraded or the
              API somehow changes ) I will post an update. Now with hashtags
              what happens is I retrieve the maximum number of replies. analyze
              each of them and find its sentiment positive, neutral, and
              negative. While with tweets I retrieve the maximum of replies and
              find the sentiment of each reply.{' '}
            </p>
            <h2 className='font-semibold mb-2 mt-4 md:text-xl'>
              Now, the more technical stuff
            </h2>
            <p className='py-3 text-left'>
              ...
              about the API, how to register and so fonh. Unlike PRAW. the
              Twitter API uses endpoints to retrieve either tweets. hashtags,
              users and soon, to be frank I'm only using a wee bit of the API
              for my purposes. I use the Python requests library to do a GET
              request of either the conversation ID or the hashtag which returns
              a JSON body with either the tweets or replies. I then use a
              classifier trained on tweets using a pickled C-Suppon Vector
              Classification and a TF-IDF Vectorizer (which is obviously a
              different one from the one used for the reddit posts) and then
              return it in a Python dict().
            </p>
          </div>
        </div>
      </section>
