...
const changelog = () => {
  return (
    <>
      {' '}
      <Head>
        <title>Comments Analyzer | Change Log</title>
      </Head>
        ...
        <div className='divide-y-2 divide-gray-100 leading-relaxed sh'>
          <div className=' mb-16'>
            ...
            <h2 className='text-gray-500 text-lg font-bold'>
              Comments Analyzer - History of application
            </h2>
            ...
            <ul className='list-disc list-inside p-3  bg-gray-100 rounded-lg'>
              ...
              <li className='list-item mb-3'>
                There are two forms where you can scrape and do sentiment
                analysis of
              </li>
              ...
              <li className='list-item mb-3'>
                ...
                sentiment with the comments, or in the case of a hashtag then
                it's the tweets that contain said hashtag.
              </li>
              <li className='list-item mb-3'>
